...
# Matrix inversion is usually a costly computation and benefit can be there
...
# the inverse has already been computed. If it is so, then it gets the result and skips the
